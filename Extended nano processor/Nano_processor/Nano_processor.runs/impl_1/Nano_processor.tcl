...
set rc [catch {
  ...
  add_files -quiet {{D:/Uni/2nd sem/Computer Organization and Digital Design/Nano processor/Finalised/Nano_processor/Nano_processor.runs/synth_1/Nano_processor.dcp}}
